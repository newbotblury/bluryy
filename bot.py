...
bot = telebot.TeleBot('8108143821:AAEqfiXpy5je8W7MENt9qvOhPHzg-IQYMEw')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Please contact @vofuxk for the access of the bot."
...
✅ Usage: /remove <userid>'''
        ...
        response = "To get access of the bot please contact @vofuxk🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "free ka maal nahi milta bhai buy karlo:- @vofuxk 🙇."
    bot.reply_to(message, response)
